...
nx::tsf::TSFManager::TSFManager(void) :
    m_hAccel(nullptr),
    m_hWnd(nullptr),
...
void nx::tsf::TSFManager::Initialize()
{
...
int nx::tsf::TSFManager::RunMessageLoop()
{
    int  nReturn = 0;
    BOOL fResult = TRUE;
...
HRESULT nx::tsf::TSFManager::ActivateTSF()
{
    HRESULT hr = S_OK;
...
HRESULT nx::tsf::TSFManager::DeactivateTSF()
{
    HRESULT hr = S_OK;
    if (m_isThreadMgrActivated) {
