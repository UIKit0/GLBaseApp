...
cd %DESTDIR%
mkdir %LANG_NAME%
muirct.exe -q ..\Resources\mui_rcconfig.xml -v 2 -x %LANG_LCID% -g 0x0409 %LIB_PREFIX%_%DLL_POSTFIX%.dll %LN_MODULE_NAME% .\%LANG_NAME%\%LIB_PREFIX%.dll.mui
