#ifndef NX_ANIMATION_ANIMATIONMANAGEREVENTHANDLER_H_
#define NX_ANIMATION_ANIMATIONMANAGEREVENTHANDLER_H_
...
{
protected:
    std::weak_ptr<animation::IAnimationStatusChangedListener> m_animationWindow;
public:
    static COM_DECLSPEC_NOTHROW HRESULT CreateInstance(
        std::weak_ptr<animation::IAnimationStatusChangedListener> animationWindow,
...
#endif // NX_ANIMATION_ANIMATIONMANAGEREVENTHANDLER_H_