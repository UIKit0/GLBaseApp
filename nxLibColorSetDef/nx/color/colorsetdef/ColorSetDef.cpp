...
std::wostream& nx::color::colorsetdef::operator<<(std::wostream& os, const ColorValueDO &colorValue)
{
...
std::wostream& nx::color::colorsetdef::operator<<(std::wostream& os, const SolidColorDO &solidColor)
{
...
std::wostream& nx::color::colorsetdef::operator<<(std::wostream& os, const LinearColorDO &linearColor)
{
...
std::wostream& nx::color::colorsetdef::operator<<(std::wostream& os, const RadialColorDO &radialColor)
{
...
std::wostream& nx::color::colorsetdef::operator<<(std::wostream& os, const ColorSetDO &colorSet)
{
    os << typeid(colorSet).name()
       << L"[colors={";
    for (size_t i = 0; i < colorSet.colors.size(); ++i) {
        std::shared_ptr<nx::color::colorsetdef::IColorDO> color = colorSet.colors[i];
        switch (color->GetColorType()) {
        case COLOR_TYPE_SOLID: {
            std::shared_ptr<nx::color::colorsetdef::SolidColorDO> solid =
                std::dynamic_pointer_cast<nx::color::colorsetdef::SolidColorDO>(color);
